...
def ETFPlotDrawing(ETFId,data,NeedStaff = True,NeedMA = True,MAtitleName = None):
    ...
    fig = make_subplots(rows=2, cols=1, shared_xaxes=True, vertical_spacing=0.2,
                        subplot_titles=(ETFId,'PETTM'), row_width=[0.2, 0.7])
    ...
    #设置布局
    layout = go.Layout(title_text=ETFId, title_font_size=30, autosize=True, margin=go.layout.Margin(l=10, r=1, b=10),
...
def StockplotDrawing(StockId,data,NeedStaff = True,NeedPE = True):
